export default {
    ...
    `,
		usernameT: 'Please enter a user name',
		passwordT: 'Please enter your password',
		usernameReq: 'User name not empty!',
		passwordReq: 'The password is not empty!',
		loginError: 'Login failed',
		EnterTdata: 'Please enter valid data',
	},
	route: {
		profile: 'Profile',
		user: 'user',
	...
	navBar: {
		...
		logout: 'Log out',
		userInfor: 'The user information',
		CPassword: 'Change the password',
		trash: 'Delete page elements',
	},
	guide: {
		close: 'close',
		next: 'next',
	...
	excel: {
		...
		failed: 'Data acquisition failed!',
	},
	role: {
		buttonTxt: 'New Role',
		index: 'Serial number',
